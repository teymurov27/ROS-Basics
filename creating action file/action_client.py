...
from udemy_pkg.msg import Navigate2DAction, Navigate2DFeedback, Navigate2DResult, Navigate2DGoal
...
if __name__ == "__main__":
    try:
        ...
        user_x = input("What is the desired x-coordinate: ")
        user_y = input("What is the desired y-coordinate: ")
        user_z = input("What is the desired z-coordinate: ")
